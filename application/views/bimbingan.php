...
<body>
  <div id="wrapper">
    ...
    <section id="content">
      ...
      Sebagai Ketua Penguji <?php echo $this->CRUD_model->ketua($id_dosen); ?> Kali, Sebagai Sekretaris <?php echo $this->CRUD_model->sekretaris($id_dosen); ?> kali
        <!-- divider -->
        <div class="row">
          <div class="span12">
      ...
      <div class="row">
          <div class="span6">
            ...
            <div class="heading">
                ...
                <a href="<?php echo site_url('sita/cetakbimbingan/1/'.$id_dosen);?>" class="btn btn-color margintop10 pull-right" >PRINT</a>
              </div>
          ...
          <div class="span6">
            ...
            <div class="heading">
                ...
                <a href="<?php echo site_url('sita/cetakbimbingan/2/'.$id_dosen);?>" class="btn btn-color margintop10 pull-right" >PRINT</a>
              </div>
              <table class="table table-striped">
                  <thead>
                    <tr>
