  ...
  <div id="wrapper">
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="row">
          <div class="span8">
            <form class="form-horizontal" action="<?php echo site_url('sita/daftarujian') ?>" method="POST" enctype="multipart/form-data" >
              <div class="row">
                <div class="span8 margintop10 field form-group">
                  <input type="text" name="nim" placeholder="NIM (Nomor Induk Mahasiswa)" style="width: 300px;" required />
                </div>
                <div class="span8 margintop10 field form-group">
                  <input type="text" name="password" placeholder="Password (Gunakan password saat mendaftar judul)" style="width: 500px;" required />
                </div>
                <div class="span4 margintop10 field form-group"> Berkas-berkas ujian </div>
                <div class="span8 margintop10 field form-group">
                  <input type="text" name="file2" placeholder="Upload Berkas-berkas ke google drive, kemudian masukan linknya disini (hapus https:// pada link)" style="width: 700px;" required />
                </div> 
                <div class="span8 margintop10 field form-group">
                  <p>
