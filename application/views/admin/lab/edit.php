...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('admin/agenda');?>">Navigasi Laboratorium</a></li>
  <li>Perbarui Sub Navigasi Laboratorium </li>
</ol>
<div id="myalert">
...
<div class="col-xs-6">
  <div class="box box-success">
    <div class="box-header">
      <h3 class="box-title"><i class="fa fa-file"></i> Edit Sub Navigasi Laboratorium</h3>
    </div>
    <div class="box-body">
      <form class="form-horizontal" action="<?php echo site_url('admin/lab/update') ?>" method="POST" enctype="multipart/form-data">
        <div class="box-body">
        ...
        <div class="box-footer">
          <a href="<?php echo site_url('admin/lab');?>" class="btn btn-default">Cancel</a>
