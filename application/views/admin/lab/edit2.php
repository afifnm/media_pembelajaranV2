...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('admin/lab');?>">Navigasi Laboratorium</a></li>
	<li>Perbarui Main Navigasi Laboratorium</li>
</ol>
<div id="myalert">
...
<div class="col-xs-6">
  <div class="box box-success">
    ...
    <div class="box-body">
      <form class="form-horizontal" action="<?php echo site_url('admin/lab/update2') ?>" method="POST" enctype="multipart/form-data">
        <div class="box-body">
